                    ...
                    <div class="newsletter-wrapper-all theme-bg-2">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-12 col-md-12">
                                <div class="newsletter-wrapper text-center" style="padding-top: 115px;">
                            ...
                            <div class="col-lg-5 col-12 col-md-12">
                                <div class="newsletter-img bg-img" >
                                    <img alt="image" src="assets/img/team/nikon-cam.png" style="height: 50%width: 100%;padding-right: 90px;">
                                </div>
                            </div>
                        </div>
                    </div>
